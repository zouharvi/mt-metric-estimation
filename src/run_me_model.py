...
if __name__ == "__main__":
    ...
    elif args.text_feature == "src+hyp+ref":
        extractor = lambda sent: sent["src"] + " [SEP] " + sent["tgts"][0][0] + " [SEP] " + sent["ref"]
    elif args.text_feature == "hyp+ref":
        extractor = lambda sent: sent["tgts"][0][0] + " [SEP] " + sent["ref"]
